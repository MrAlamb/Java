package bsu.rfe.java.group8.lab2.Ambrazhei.varA1;
...
private void addRadioButton(String buttonName, final int formulaId) { 
	...
	public void actionPerformed(ActionEvent ev) {
		MainA.this.formulaId = formulaId; 
		} 
	});
...
textFieldResult.setText(Double.toString(result));
  ...
  { 
	JOptionPane.showMessageDialog(MainA.this,"Ошибка в формате записи числа с плавающей точкой", "Ошибочный формат числа", JOptionPane.WARNING_MESSAGE);
  }
}
});
